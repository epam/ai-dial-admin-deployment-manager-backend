...
public abstract class ImageDefinitionFunctionalTest {
    ...
    public void shouldSuccessfullyCreateAndGetImageDefinitionByType() {
        ...
        List<ImageDefinition> imageDefs = service.getAllImageDefinitionsByType(DeploymentTypeDto.MCP, Pageable.unpaged()).getContent();
    ...
    public void shouldGetImageDefinitionViewsByType() {
        ...
        // When
        var pageRequest = PageRequest.of(0, 5);
        var mcpViews = service.getImageDefinitionViewsByType(DeploymentTypeDto.MCP, pageRequest).getContent();
        var interceptorViews = service.getImageDefinitionViewsByType(DeploymentTypeDto.INTERCEPTOR, pageRequest).getContent();
