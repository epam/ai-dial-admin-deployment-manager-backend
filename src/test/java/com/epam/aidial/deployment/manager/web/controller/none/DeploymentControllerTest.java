...
class DeploymentControllerTest extends AbstractControllerNoneSecureTest {
    ...
    void testGetPods_withRestartInfo() throws Exception {
        ...
        var podInfo = new PodInfo("pod-1", null, null, createdAt, 5, "OOMKilled",
                "Container exceeded its memory limit", 137, 9, finishedAt, null, null, null);
    ...
    void testGetPods_withoutTerminationInfo() throws Exception {
        ...
        var createdAt = Instant.parse("2023-01-01T12:00:00Z");
        var finishedAt = Instant.parse("2023-01-01T12:10:00Z");
        var podInfo = new PodInfo("pod-2", null, null, createdAt, 0, null, null, null, null, finishedAt, null, null, null);
    ...
    void testGetActivePods() throws Exception {
        ...
        var createdAt = Instant.parse("2023-01-01T12:00:00Z");
        var finishedAt = Instant.parse("2023-01-01T12:10:00Z");
        var podInfo = new PodInfo("pod-3", null, null, createdAt, 2, "Error", null, 1, null, finishedAt, null, null, null);
