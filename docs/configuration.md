...
| `app.image-name-format`    | `IMAGE_NAME_FORMAT`      | `app-%`    | No    | -            | Name format for images that are built using Deployment Manager. Must contain % that will be replaced by image definition ID.                                                                               |
