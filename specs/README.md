...
| [018-explicit-pool-scheduling](018-explicit-pool-scheduling/spec.md) | Draft | deployments | Replace derived label-key + capacity-numbers pool config with explicit nodeSelector/affinity/tolerations; create-time defaults cascade for new deployments |
