...
- Log4j2 core version: 2.25.3 (`log4j-core`, `log4j-slf4j2-impl`, `log4j-jul`)
- OTel Log4j2 appender: `opentelemetry-log4j-appender-2.17:1.33.6-alpha`
- OTel Spring Boot starter: `opentelemetry-spring-boot-starter:2.12.0` (BOM: `opentelemetry-instrumentation-bom:2.12.0`)
