...
- **FR-007**: System MUST support filtering activities by: activity ID, activity type, resource type, resource identifier, author name, author email, and timestamp range (from/to epoch milliseconds).
