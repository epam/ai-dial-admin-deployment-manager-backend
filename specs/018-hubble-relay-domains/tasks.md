...
- [ ] T030 Run `./gradlew generateDbSchema` to regenerate `docs/db-schema.md` after the V1.58 and V1.59 migrations are in place; commit the updated file
...
T008: V1.58 migrations (all vendors)
T009: V1.59 migrations (all vendors)
